...
| ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| *{m, c, s, t}*                                 | *m* 为大小调(0大调，1小调);<br>*c* 为中心音([0, 11]);<br>*s* 为移调(已废弃，置0);<br>*t* 为速度(即乐谱左上角标记的一个四分音符所等于的数字); |
| *{m, c, s, t, v}*                              | *v* 为音量;                                                                                                                                  |
...
| 延音   | *{背景音, {主题旋律}}*                                                | 背景音可由音符或和弦组成, 主题旋律可以是上述任何类型               |
...
可参考示例代码 _Demo_BWV-1079.nb_ 或浏览我的 Mathematica 音乐库 <https://mathmusic.vercel.app> 来弄清具体用法; 生成乐谱之前请先运行 _mathmusic_macro.nb_
